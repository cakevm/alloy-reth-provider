// FORK FROM: https://github.com/bluealloy/revm/blob/389be74/crates/database/interface/src/async_db.rs
...
pub trait DatabaseAsyncRef {
    ...
    /// Gets storage value of address at index.
    fn storage_async_ref(&self, address: Address, index: U256) -> impl Future<Output = Result<U256, Self::Error>> + Send;

    /// Gets block hash by block number.
    fn block_hash_async_ref(&self, number: u64) -> impl Future<Output = Result<B256, Self::Error>> + Send;
}
